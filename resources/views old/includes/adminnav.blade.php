                        ...
                        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                            ...
                            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Admins">
                                ...
                                <ul class="sidenav-second-level collapse" id="collapseComponents">
                                    <li>
                                        <a href="{{url('admin/admins')}}">All admins</a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/addadmin')}}"> Add admin</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Shops">
                                ...
                                <ul class="sidenav-second-level collapse" id="collapseCompo">
                                    <li>
                                        <a href="{{url('admin/shops')}}">All shops</a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/addshop')}}">Add shop</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Orders">
                                <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#Multi" data-parent="#exampleAccordion">
                                    <i class="fa fa-fw fa-gift"></i>
                                    <span class="nav-link-text">Orders</span>
                                </a>
                                <ul class="sidenav-third-level collapse" id="Multi">
                                    <li>
