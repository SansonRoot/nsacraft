...
<head>
    <title>Coming Soon 1 | Nsacraft - Where crafts meet business</title>
...
<div class="container cooming-soon-content valign__middle">
    ...
    <div class="row">
        <div class="col-md-12 coming-soon">
            <h1>Hi, we're <span class="color-green">Nsacraft</span></h1>
            <h2 class="test-info">We Are Coming Soon!</h2><br>

            <h3 class="test-info1">Shops / Delivery / Customers</h3>
...
<script type="text/javascript" src="{{asset('assets/js/page_coming_soon.js')}}"></script>
