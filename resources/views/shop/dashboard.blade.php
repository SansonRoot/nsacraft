            ...
            <div class="col-md-3 md-margin-bottom-40">
                ...
                <ul class="list-group sidebar-nav-v1 margin-bottom-40" id="sidebar-nav-1">
                    <li class="list-group-item active">
                        <a href=""><i class="fa fa-product-hunt"></i> Products</a>
                    </li>
                    <li class="list-group-item">
                        <a href=""><i class="fa fa-exchange"></i> Transactions</a>
                    </li>
                    <li class="list-group-item">
                        <a href=""><i class="fa fa-bell"></i> Notifications<span class="badge badge-sea rounded-x">3</span></a>
                    </li>
                    <li class="list-group-item">
                        <a href=""><i class="fa fa-cubes"></i> Orders</a>
                    </li>
                    {{--<li class="list-group-item">--}}
                ...
                <a rel="pulse-grow" class="btn-u btn-u-blue pulse-grow">Go premium</a>
